...
def parse_args():
    ...
    parser.add_argument('--attack', type=str, default='', help='attack')
    ...
    # ========================= Data Configs ==========================
    parser.add_argument('--train_annotation', type=str, default=datapath+'train_new.json')
    parser.add_argument('--test_annotation', type=str, default=datapath+'test_new.json')
    parser.add_argument('--test_output_csv', type=str, default=datapath+'submit_example_A.csv')
    ...
    parser.add_argument('--ckpt_file', type=str, default='./save/flod_/model_epoch_13_mean_f1_0.6449.bin')
